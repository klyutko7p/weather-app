<template>
    <div v-if="!isLoading">
        ...
        <div class="xl:flex xl:items-center xl:justify-between mt-10 mb-16 lg:block">
            <div class="text-center text-lg bg-white text-black rounded-3xl p-10 ">
                <div class="text-5xl">
                ...
                <div class="flex items-center justify-center text-2xl font-extrabold max-[330px]:text-[16px] ">
            ...
            <div class="xl:w-1/2 lg:w-full">
                <h1 class="text-2xl font-bold mb-2 max-sm:mt-5">Choose the day</h1>
                <select v-model="selectedDate"
                    class="block w-full px-4 py-3 text-2xl text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500">
                ...
                <div class="text-right">
                    <MainButton class="mt-2" @click="parseTime(), parseDaily()">Update day</MainButton>
                </div>
